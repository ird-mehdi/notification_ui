...
class NotificationScreen {
  ...
  static Size get _size => MediaQuery.sizeOf(QuranMajeedApp.globalContext!);
...
extension QuranScreenWidth on Widget {
  ...
  double get onePercentWidth {
    ...
    _onePercentWidth ??= NotificationScreen.width * onePercent;
  ...
  double get twoPercentWidth {
    ...
    _twoPercentWidth ??= NotificationScreen.width * twoPercent;
  ...
  double get fiftyPercentHeight {
    ...
    _fiftyPercentHeight ??= NotificationScreen.height * fiftyPercent;
  ...
  double get threePercentWidth {
    ...
    _threePercentWidth ??= NotificationScreen.width * threePercent;
  ...
  double get sixPercentWidth {
    ...
    _sixPercentWidth ??= NotificationScreen.width * sixPercent;
  ...
  double get sevenPercentWidth {
    ...
    _sevenPercentWidth ??= NotificationScreen.width * sevenPercent;
  ...
  double get eightPercentWidth {
    ...
    _eightPercentWidth ??= NotificationScreen.width * eightPercent;
  ...
  double get tenPercentWidth {
    ...
    _tenPercentWidth ??= NotificationScreen.width * tenPercentWidth;
  ...
  double get fortyPercentWidth {
    ...
    _fortyPercentWidth ??= NotificationScreen.width * fortyPercent;
  ...
  double get thirtyPercentWidth {
    ...
    _thirtyPercentWidth ??= NotificationScreen.width * thirtyPercentWidth;
  ...
  double get seventyPercentWidth {
    ...
    _seventyPercentWidth ??= NotificationScreen.width * seventyPercent;
  ...
  double get tweentyEightPercentWidth {
    ...
    _tweentyEightPercentWidth ??=
        NotificationScreen.width * tweentyEightPercentWidth;
  ...
  double get twentyPercentWidth {
    ...
    _twentyPercentWidth ??= NotificationScreen.width * twentyPercentWidth;
  ...
  double get twentyFivePercentWidth {
    ...
    _twentyFivePercentWidth ??=
        NotificationScreen.width * twentyFivePercentWidth;
  ...
  double get twentySixPercentWidth {
    ...
    _twentySixPercentWidth ??= NotificationScreen.width * twentySixPercentWidth;
  ...
  double get twentyThreePercentWidth {
    ...
    _twentyThreePercentWidth ??=
        NotificationScreen.width * twentyThreePercentWidth;
  ...
  double get fourtyPercentWidth {
    ...
    _fourtyPercentWidth ??= NotificationScreen.width * fourtyPercentWidth;
  ...
  double get twentyPercentHeight {
    ...
    _twentyPercentHeight ??= NotificationScreen.height * twentyPercent;
  ...
  double get tenPercentHeight {
    ...
    _tenPercentHeight ??= NotificationScreen.height * tenPercentHeight;
  ...
  double get twelvePercentHeight {
    ...
    _twelvePercentHeight ??= NotificationScreen.height * twentyPercent;
  ...
  double get fourteenPercentHeight {
    ...
    _fourteenPercentHeight ??=
        NotificationScreen.height * fourteenPercentHeight;
  ...
  double get tweentyPercentHeight {
    ...
    _tweentyPercentHeight ??= NotificationScreen.height * tweentyPercentHeight;
...
extension DeviceExt on num {
  ...
  double get percentHeight {
    _heightPercent ??= NotificationScreen.height / 100;
  ...
  double get percentWidth {
    _widthPercent ??= NotificationScreen.width / 100;
...
double _calculateQuranScreenWidthQuarterPercentage() {
  return (NotificationScreen.width / 3.9) / 100;
}
